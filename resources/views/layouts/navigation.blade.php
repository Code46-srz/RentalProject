 <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
     ...
     <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="primaryNavigation">
         <div class="flex justify-between ">
             <div class="flex">
                 ...
                 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                     ...
                     <x-nav-link id="showRent" {{-- :href="route('rent')" :active="request()->routeIs('about')" --}}>
                         {{ __('Rent') }}
                     </x-nav-link>
                     <x-nav-link id="showBuy" {{-- :href="route('buy')" :active="request()->routeIs('about')" --}}>
                         {{ __('Buy') }}
                     </x-nav-link>
